...
public class MultiRobotPanel extends MultiRobotPanelInterf //implements GUIMonitor
{
	// Global constants
...
//		rootSP.setDividerLocation(0.8);
	...
	public void sendBUTActionPerformed(java.awt.event.ActionEvent e) 
	{
		...
		/*
		monitor.setID ("IFORK-1");	
		monitor.setPlan (new Sequence (">L1-Entrada<load>|>L2-Salida<load>|", "><|"));
		
		monitor.setID ("IFORK-2");	
		monitor.setPlan (new Sequence (">L1-Entrada<load>|>L2-Salida<load>|", "><|"));
		*/
	}
