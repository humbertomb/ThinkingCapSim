...
public class PLSDatagram implements Serializable
{
	...
	protected byte				address;							/** Address. Byte de dirección de la trama. */
	protected short				length;							/** Length. Longitud de la trama. Incluye el tamaño del campo de comando y el de datos. */
	protected byte				comando;							/** CMD. Byte de comando de la trama del HOST->LMS200. Cuando LMS200 responde a HOST añade 0x80 a la orden original CMD. */
