...
/**
 * Modal editor of the robot description of a running application (the
 * simulator, for instance): a {@link RobotEditorPanel} with its File menu and
 * the OK / Cancel buttons. A copy of the description is edited;
 * {@link #showDialog()} returns the edited copy, or null when cancelled,
 * leaving the original untouched.
 */
public class RobotEditorDialog extends JDialog implements RobotEditorPanel.Host
{
	...
	protected RobotDef				result;

	/** @param robot  description to edit (a copy is edited; {@link #showDialog()} returns it when accepted) */
	public RobotEditorDialog (Window owner, RobotDef robot)
	{
		super (owner, TITLE, ModalityType.APPLICATION_MODAL);
		editor	= new RobotEditorPanel (robot.copy (), this);
	...
	/** Shows the dialog; returns the edited description, or null when cancelled. */
	public RobotDef showDialog ()
	{
		result	= null;
		setVisible (true);
		return result;
