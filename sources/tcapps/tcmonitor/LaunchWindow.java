...
public class LaunchWindow extends JFrame 
{
	...
	public void initComponents() throws Exception 
	{
		...
		spioneerBU.setText("Pioneer3AT");
		siasfBU.setVisible(true);
		siasfBU.setText("IASF");
		...
		siasfBU.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				siasfBUActionPerformed(e);
			}
		});
