...
//	private static final double kM = 1024;
	...
	*  coefficients[] = {A, B, C, D, E}.
	*
	*  @returns Reference to an array of complex coefficients in order
	*           of decreasing power.
	**/
	...
	**/
    public boolean equals(Object obj) {
		...
		if (coef == null) {
			if (newObj.coef.length == 1 && newObj.coef[0].re() == 0 && newObj.coef[0].im() == 0)
				return true;
			else
				return false;
		}
		if (newObj.coef == null) {
			if (coef.length == 1 && newObj.coef[0].re() == 0 && newObj.coef[0].im() == 0)
				return true;
			else
				return false;
		}
